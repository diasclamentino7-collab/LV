...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "e a ferramentas para criar, atualizar ou remover convidados, tarefas, "
    "fornecedores, documentos legais, categorias de orçamento, despesas, "
    "pagamentos, notas de comunicação e inspirações do moodboard, além de "
    "abrir páginas da internet (ex.: o site de um fornecedor). Usa as "
    ...
    "'Remover' arquiva o registo (fica recuperável em Todos os eliminados), "
    "nunca apaga em definitivo. Existe também 'permanently_delete_record', "
    "que apaga mesmo para sempre — só a usem depois de o casal confirmar "
    "de forma clara e inequívoca, na própria conversa, que é isso que "
    "querem (não apenas 'remove-o'); em caso de dúvida, arquivem e "
    "perguntem antes.\n\n"
